    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carloan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText( emicalc.this, "Please enter a valid on road price of car",Toast.LENGTH_SHORT).show();
                    return;
                }
                else
                {
                    if(checkdown.matches("")){
                    Toast.makeText( emicalc.this, "Please enter a valid down payment price of car",Toast.LENGTH_SHORT).show();
                    return;
                }
                    else{
        ...
        emires.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(finalloan.matches("")&&interest.matches("")&&month.matches("")){
                    Toast.makeText(emicalc.this,"All the fields are required", Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
